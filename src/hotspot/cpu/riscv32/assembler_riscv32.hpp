...
#ifndef CPU_RISCV32_VM_ASSEMBLER_RISCV32_HPP
#define CPU_RISCV32_VM_ASSEMBLER_RISCV32_HPP
...
#undef INSN
  ...
  // The maximum range of a branch is fixed for the riscv32
  // architecture.
...
#endif // CPU_RISCV32_VM_ASSEMBLER_RISCV32_HPP
